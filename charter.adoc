...
The External Debug Security Task Group aims to [INSERT CLEAR, CONCISE OVERALL MISSION STATEMENT IN 2-3 SENTENCES].
...
The External Debug Security Task Group is committed to delivering [SPECIFY DELIVERABLE] with the following attributes:
...
To fulfill its objectives, the External Debug Security Task Group will engage with:
